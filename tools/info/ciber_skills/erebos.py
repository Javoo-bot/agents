...
import os
import random
from backend.app.core.graph.skills.ciber_skills.hermes import DateTimeEncoder, DictLogHandler

logger = logging.getLogger(__name__)
logger.setLevel(logging.ERROR)  # Testear si quito esto que se va a imprimir en pantalla

# Initialize Groq client
groq_client = ChatGroq(api_key="api_key", model_name="model_name")
